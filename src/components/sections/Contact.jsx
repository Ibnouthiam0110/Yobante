  ...
  return (
    <section id="contact" className="section alt">
      ...
      <style jsx>{`
        ...
        .section-tag { display: flex; align-items: center; gap: 12px; color: #00BFFF; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px; font-size: 14px; margin-bottom: 20px; }
        .tag-line { width: 30px; height: 2px; background: #faf066; }
        .contact-title { font-size: 36px; color: #00BFFF; font-weight: 800; margin-bottom: 20px; line-height: 1.2; }
        ...
        input:focus, select:focus, textarea:focus { border-color: #00BFFF; box-shadow: 0 0 0 4px rgba(0,191,255,0.05); background: white; }
        ...
        .submit-btn { width: 100%; padding: 16px; background: #00BFFF; color: white; border: none; border-radius: 12px; font-weight: 700; font-size: 16px; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 10px; transition: all 0.3s; }
        .submit-btn:hover:not(:disabled) { background: #00BFFF; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(0,191,255,0.2); }
